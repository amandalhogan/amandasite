          ...
          <PostBody>
            ...
            <div className="mt-8">
              <Link
                ...
                className="inline-block rounded-full border border-emerald-800 px-6 py-3 text-sm font-bold uppercase tracking-widest text-emerald-800 transition-colors hover:bg-emerald-800 hover:t[...]"
              >
                Play Game
              </Link>
            </div>
